  ...
  test: {
    ...
    coverage: {
      include: [
        ...
        "src/compiler/generation-retention.ts",
        "src/compiler/output-limits.ts",
        ...
        "src/recovery/recovery-store.ts",
        ...
        "src/support/application-log.ts",
      ],
      provider: "v8",
